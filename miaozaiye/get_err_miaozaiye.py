...
filename = '/Users/Jane/Desktop/Python 全栈学习/python3 learning/lesson7/err_object_list.txt'
...
export_pickle(errlist,filename)
    return errlist




def export_pickle(errlist, filename, compress=False):
    fh = None
    try:
        if compress:
        ...
        pickle.dump(errlist, fh, pickle.HIGHEST_PROTOCOL)
        return True
